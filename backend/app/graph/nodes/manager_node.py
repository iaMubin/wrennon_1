...
def manager_node(state: ConversationState) -> ConversationState:
    ...
    system_prompt = (
        ...
        "Available Tools:\n"
        "1. get_order_status: Fetches tracking information. Requires 'order_id' and 'email'.\n"
        ...
        "2. If the user provides an order ID but no email, you cannot use get_order_status yet (the Final Reply LLM will ask for it).\n"
