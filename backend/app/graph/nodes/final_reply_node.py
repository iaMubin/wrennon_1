...
async def final_reply_node(state: ConversationState) -> ConversationState:
    ...
    system_instruction = (
        ...
        "- You MUST disclose that you are an AI assistant ONLY in your initial greeting. DO NOT repeatedly introduce yourself in subsequent messages. Do NOT start every message with a greeting.\n"
